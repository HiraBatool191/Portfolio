    ...
    <div className="flex flex-col gap-4 items-center">
      ...
      {socialLinks.map((item, index) => (
        <Link
          ...
          className="relative group flex items-center text-primary/80 hover:text-cyan-600 transition-all"
        >
          {item.icon}
          <span
            className="
              ...
              text-sm bg-cyan-300 text-cyan-700 px-2 py-1 rounded-md whitespace-nowrap
            "
          >
            {item.label}
          </span>
